                    ...
                    <div class="span_1_of_6 bg-f7f">
                        ...
                        <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                            <div class="themesflat-headings style-2 clearfix">
                                ...
                                <h2 class="heading font-size-28 line-height-39">ALUMINUM DIE SHOP</h2>
                                <div class="sep has-width w80 accent-bg margin-top-20 clearfix"></div>
                                <p class="sub-heading margin-top-33 line-height-24">Delmar owns and operates a die-cast factory for the production of molds used in the pressing process, which determines the shapes of aluminum sectors. This factory consists of wire cutting machines, spark engraving, CNC fraise machine and manual fraise with the most advanced global technologies to ensure the accuracy required in the manufacturing of molds.</p>
                            </div>
                        </div>
