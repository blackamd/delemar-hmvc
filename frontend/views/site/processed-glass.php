                    ...
                    <div class="span_1_of_6 bg-f7f">
                        ...
                        <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                            <div class="themesflat-headings style-2 clearfix">
                                ...
                                <h2 class="heading font-size-28 line-height-39">PROCESSED GLASS</h2>
                                <div class="sep has-width w80 accent-bg margin-top-20 clearfix"></div>
                                <p class="sub-heading margin-top-33 line-height-24">Our factory is an iconic facility in the glass industry. The automated glass handling systems, the precision of the silicone filling by the robotic arms, the finer details that make every piece of glass special, the purity of water every glass is subjected to, and the high-speed fully automated cutting systems make our factory unprecedented in the Egyptian market.</p>
                            </div>
                        </div>
