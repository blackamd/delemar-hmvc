                        ...
                        <div id="rev-slider1" class="rev_slider fullwidthabanner">
                            <ul>
                                ...
                                <li data-transition="random">
                                    <!-- Main Image -->
                                    <img src="<?= Url::to(['../frontend/web/assets_tamplet/img/slider/slider-bg-2.jpg'])?>" alt="" data-bgposition="center center" data-no-retina>
                                    ...
                                    <div class="tp-caption tp-resizeme text-white font-heading font-weight-600"
                                        ...
                                        DELEMAR GROUP IS A LEADER IN INFRASTRUCTURE
                                    </div>
                                ...
                                <li data-transition="random">
                                    <!-- Main Image -->
                                    <img src="<?= Url::to(['../frontend/web/assets_tamplet/img/slider/slider-bg-1.jpg'])?>" alt="" data-bgposition="center center" data-no-retina>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="elm-button text-center">
                                        <a href="<?= Url::to(['site/page-about'])?>" class="themesflat-button bg-accent">ABOUT US</a>
                                    </div>
                                ...
                                <div class="col-md-6 bg-light-grey">
                                    ...
                                    <div class="themesflat-content-box clearfix" data-margin="0 25% 0 4.5%" data-mobilemargin="0 0 0 4.5%">
                                        <div class="themesflat-headings style-1 clearfix">
                                            <h2 class="heading">WELCOME TO DELEMAR GROUP</h2>
                                            <div class="sep has-width w80 accent-bg margin-top-11 clearfix"></div>
                                            <p class="sub-heading margin-top-30">We have successfully completed projects in numerous states across Egypt. Delemar Group has a proven track record of:</p>
                                        </div>
                                        ...
                                        <div class="elm-button">
                                            <a href="<?= Url::to(['site/page-about'])?>"  class="themesflat-button bg-white">GET IN TOUCH</a>
                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="themesflat-spacer clearfix" data-desktop="60" data-mobile="60" data-smobile="60"></div>
                                    <div class="themesflat-headings style-1 text-center clearfix">
                                        <h2 class="heading">DELEMAR FACTORIES</h2>
                                        <div class="sep has-icon width-125 clearfix">
                                            <div class="sep-icon">
                                                <span class="sep-icon-before sep-center sep-solid"></span>
                                                <span class="icon-wrap"><i class="autora-icon-build"></i></span>
                                            ...
                                            <div class="themesflat-image-box style-1 has-icon icon-right w65 clearfix">
                                                <div class="image-box-item">
                                                    <div class="inner">
                                                        ...
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="<?= Url::to(['site/aluminum-die-shop'])?>">ALUMINUM DIE SHOP</a></h5>
                                                            <span class="icon-wrap">
                                                                <i class="fa fa-angle-right"></i>
                                                            </span>
                                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="themesflat-headings style-1 text-center clearfix">
                                        <h2 class="heading font-size-30">WORKING WITH DELEMAR MEANS</h2>
                                        <div class="sep has-icon width-125 clearfix">
                                            <div class="sep-icon">
                                                <span class="sep-icon-before sep-center sep-solid"></span>
                                                <span class="icon-wrap"><i class="autora-icon-build"></i></span>
                            ...
                            <div class="themesflat-row gutter-30 clearfix">
                                <div class="col span_1_of_4">
                                    <div class="themesflat-icon-box icon-left accent-color style-2 clearfix">
                                        ...
                                        <div class="text-wrap">
                                            <h5 class="heading"><a href="#">ONE-STOP SOLUTION</a></h5>
                                ...
                                <div class="col span_1_of_4">
                                    ...
                                    <div class="themesflat-icon-box icon-left accent-color style-2 clearfix">
                                        ...
                                        <div class="text-wrap">
                                            <h5 class="heading"><a href="#">SUSTANINABLE BUSINESS</a></h5>
                                ...
                                <div class="col span_1_of_4">
                                    ...
                                    <div class="themesflat-icon-box icon-left accent-color style-2 clearfix">
                                        ...
                                        <div class="text-wrap">
                                            <h5 class="heading"><a href="#">EASILY SCALABLE</a></h5>
                    ...
                    <div class="row-partner">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="themesflat-headings style-1 text-center clearfix">
                                        <h2 class="heading font-size-30">OUR CLIENTS</h2>
                                        <div class="sep has-icon width-125 clearfix">
                                            <div class="sep-icon">
                                                <span class="sep-icon-before sep-center sep-solid"></span>
                                                <span class="icon-wrap"><i class="autora-icon-build"></i></span>
